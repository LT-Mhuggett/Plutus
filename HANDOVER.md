...
| **Till build to run** | **`D:\tmp\plutus-till-1.31.0\Plutus.Frontend.AppClient.exe`** — unpackaged, no signing needed. Stamp `1.29.0+6fa2ac2` |
...
| **Versions** | till-maui **1.31.0** · platform **1.25.0** · backend **1.8.3** · portal **1.3.0** · till-web **1.5.0** |
