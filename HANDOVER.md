...
| | |
|---|---|
| **Suite** | Unit **844** · Integration **146** · Architecture **15** · AppClient **409** (+3 skipped) — all green |
| **Till build to run** | **`D:\tmp\plutus-till-1.38.0\Plutus.Frontend.AppClient.exe`** — unpackaged, no signing needed. Stamp `1.29.0+6fa2ac2` |
...
| **Versions** | till-maui **1.38.0** · platform **1.25.0** · backend **1.8.3** (⚠ **1.9.0 built, NOT deployed**) · portal **1.3.0** · till-web **1.5.0** |
