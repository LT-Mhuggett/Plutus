...
| **Till build to run** | **`D:\tmp\plutus-till-1.24.0\Plutus.Frontend.AppClient.exe`** — unpackaged, no signing needed. Stamp `1.24.0+2edd77f` |
...
| **Versions** | till-maui **1.24.0** · platform **1.22.0** · backend **1.8.1** · portal **1.3.0** · till-web **1.5.0** |
