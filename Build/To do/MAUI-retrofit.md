...
| till-maui | **1.92.0** | ✅ **BUILT 2026-08-18 (evening, 6th)** at `D:\tmp\plutus-till-1.92.0`; `1.92.0+25c5707b` = HEAD, six of the new strings verified inside the binary. ⚠ The only build on the box. ⚠ Needs backend 1.17.8. ⚠ Carries **WP-L1b's MAUI half** — the customer detail view with the full history, Grant credit and Edit details. |
