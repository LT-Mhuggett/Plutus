...
| till-maui | **1.87.0** | ✅ **BUILT 2026-08-18 (evening)** at `D:\tmp\plutus-till-1.87.0`; artefact reads `1.87.0+9da2b5f2` = HEAD, and **six strings from this session's work were found inside the binary**. ⚠ **The only build on the box** — 1.81.0 deleted. ⚠ Needs backend 1.17.4 (above). §G38–§G43 are all new and none has been run. |
