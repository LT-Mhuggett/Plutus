...
| till-maui | **1.93.0** | ✅ **BUILT 2026-08-18 (late)** at `D:\tmp\plutus-till-1.93.0`; `1.93.0+9b447759` = HEAD, four print-card strings verified inside the binary. ⚠ The only build on the box. ⚠ Needs backend 1.17.8. ⚠ Carries **Print card** (a thermal membership slip — see WP-L1c for why it is not a CR80 card). |
