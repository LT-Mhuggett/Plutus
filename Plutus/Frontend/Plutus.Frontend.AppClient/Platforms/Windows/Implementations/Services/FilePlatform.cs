    ...
    class FilePlatform : IFile
    {
        ...
        public async Task<bool> SaveAndView(string fileName, string contentType, MemoryStream stream, IDictionary<string, IList<string>> listFileTypes)
        {
            ...
            if (outFile != null)
            {
                ...
                {
                    await global::Windows.System.Launcher.LaunchFileAsync(outFile);
                    return true;
                }
                else
                    return false;
        ...
        public async Task<IList<(string fileName, bool status)>> SaveFiles(IList<(string fileName, string contentType, MemoryStream stream, string extension)> fileData)
        {
            ...
            WindowInterop.InitializeWithCurrentWindow(folderPicker);
            fileData.ForEach(fD =>
            {
            ...
            await global::Windows.System.Launcher.LaunchFolderAsync(folderToSaveIn);
            folderToSaveIn = null;
            return results;
        }
        ...
        private FileOpenPicker GetFileOpenPicker(IList<string> listFileTypes)
        {
            ...
            WindowInterop.InitializeWithCurrentWindow(filePicker);
