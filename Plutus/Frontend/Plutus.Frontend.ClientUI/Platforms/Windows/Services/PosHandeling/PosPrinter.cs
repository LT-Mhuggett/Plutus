...
{
    public class PosPrinter : PosObjectContract<Windows.Devices.PointOfService.PosPrinter>
    {
        #region Fields
        private Windows.Devices.PointOfService.PosPrinter _printer;
        ...
        {
            _printer = await Windows.Devices.PointOfService.PosPrinter.FromIdAsync(DeviceId);
            if (_printer == null)
        ...
        protected override Task<Windows.Devices.PointOfService.PosPrinter> GetFirstPOSObjectAsync(PosConnectionTypes posConnectionTypes = PosConnectionTypes.All)
        {
            throw new NotImplementedException();
        }
        #endregion

        public static Dictionary<string, object> GetCapabilites(Windows.Devices.PointOfService.PosPrinter printer)
        {
