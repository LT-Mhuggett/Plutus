...
//
// This is the OPERATOR login only. The till's DEVICE enrolment token (pipeline.ts) stays HMAC and
// is unaffected — the backend routes 2-segment device tokens to the HMAC handler under every IdP.
