...
// Fills with currentColor so it takes the accent of whatever it sits in (white on the
// appbar band, accent blue on the login card); the tab/PWA icon carries the blue tile.
